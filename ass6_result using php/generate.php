...
<img align="right" src="logo.jpg" width="110" height="110" /> <center><h1>Provisional Marksheet</h1>
...
$total_mse = $wt_mse + $daa_mse + $cd_mse + $cc_mse; $total_ese = $wt_ese + $daa_ese + $cd_ese + $cc_ese; $total_marks = (($total_mse * 0.3) + ($total_ese * 0.7)); $percentage = (($total_marks / 400) * 100); $sgpa =(($percentage+7.5) / 10);
...
} elseif($sgpa >= 9) { $grade = 'A';
} elseif($sgpa >= 8) { $grade = 'B+';
} elseif($sgpa >= 7) { $grade = 'B';
} elseif($sgpa >= 6) { $grade = 'C+';
} elseif($sgpa >= 5) { $grade = 'C';
} elseif($sgpa >= 4) { $grade = 'D';
} else {
...
<h2 style = "text-align:center;">Result</h2> <div class="details">
...
<h3 class="coe">Controller of Examinations</h3> </body>
